...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean updateBTData(int [] v,int id,String ln,String d){
        ...
        contentValues.put(COL_BT_4,v[0]);
        contentValues.put(COL_BT_5,v[1]);
        contentValues.put(COL_BT_2,v[2]);
        contentValues.put(COL_BT_3,v[3]);
        contentValues.put(COL_BT_4,v[4]);
        contentValues.put(COL_BT_5,v[5]);
        contentValues.put(COL_BT_2,v[6]);
        contentValues.put(COL_BT_3,v[7]);
        contentValues.put(COL_BT_4,v[8]);
        contentValues.put(COL_BT_5,v[9]);
        contentValues.put(COL_BT_2,v[10]);
        contentValues.put(COL_BT_3,v[11]);
        contentValues.put(COL_BT_4,v[12]);
        contentValues.put(COL_BT_5,v[13]);
        contentValues.put(COL_BT_2,v[14]);
        contentValues.put(COL_BT_3,v[15]);
        contentValues.put(COL_BT_4,v[16]);
        contentValues.put(COL_BT_5,v[17]);
        contentValues.put(COL_BT_2,v[18]);
        contentValues.put(COL_BT_3,v[19]);
        contentValues.put(COL_BT_4,v[20]);
        contentValues.put(COL_BT_5,v[21]);
        contentValues.put(COL_BT_2,v[22]);
        contentValues.put(COL_BT_3,v[23]);
        contentValues.put(COL_BT_4,v[24]);
        contentValues.put(COL_BT_5,v[25]);
        contentValues.put(COL_BT_2,v[26]);
        contentValues.put(COL_BT_3,v[27]);
