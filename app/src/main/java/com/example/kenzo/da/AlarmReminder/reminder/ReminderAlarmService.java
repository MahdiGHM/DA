package com.example.kenzo.da.AlarmReminder.reminder;
...
import com.example.kenzo.da.AlarmReminder.AddReminderActivity;
...
public class ReminderAlarmService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = new NotificationChannel(CHANNEL_ID, "CH", importance);
